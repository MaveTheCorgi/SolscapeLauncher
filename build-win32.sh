...
cp native/build-x86/src/Release/Solscape.exe build/win-x86/
cp target/Solscape.jar build/win-x86/
...
echo Solscape.exe 32bit sha256sum
sha256sum build/win-x86/Solscape.exe

dumpbin //HEADERS build/win-x86/Solscape.exe
