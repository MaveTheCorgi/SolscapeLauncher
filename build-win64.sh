...
cp native/build-x64/src/Release/Solscape.exe build/win-x64/
cp target/Solscape.jar build/win-x64/
...
echo Solscape.exe 64bit sha256sum
sha256sum build/win-x64/Solscape.exe

dumpbin //HEADERS build/win-x64/Solscape.exe
