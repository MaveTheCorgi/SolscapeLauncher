...
1) Go into launcher.properties And edit 'Solscape' and links to your server links and name
...
runelite.download.link=https://**Solscape**.net/download/  
runelite.website=https://**Solscape**.net/  
runelite.bootstrap=https://Solscape.s3.eu-west-2.amazonaws.com/bootstrap.json  
runelite.bootstrapsig=https://Solscape.s3.eu-west-2.amazonaws.com/bootstrap.json.sha256  
runelite.name=**Solscape**  
...
Make sure CC is selected and replace 'Solscape' with 'MyCoolName' MAKE SURE ITS CAPS E same with the server name

3) Inside Intellij click the root of the project and press CTRL + ALT + R

Make sure CC is selected and replace 'Solscape' with 'myCoolName' MAKE SURE ITS LOWERCASE E same with the server name
...
Once you have pushed your files to github, github actions will build your launcher you can then find them under the workflow action it runs EG: https://github.com/Solscape-Community/Runelite-Launcher-rsps/actions/runs/3014844052
